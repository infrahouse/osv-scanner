...
```shell
$ bin/omnibus clean osv-scanner
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/osv-scanner`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean osv-scanner --purge
```
...
[vagrant@ubuntu...] $ cd osv-scanner   # or 'cd osv-scanner/omnibus' if your omnibus project is embedded in your main project
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ bin/omnibus build osv-scanner
```
